...
test('should throw an error if the identifier is unsupported', async t => {
  const wrong =
    '$script$ln=16,r=8,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';

  const err = await t.throws(m.verify(wrong, 'password'));
  t.is(err.message, 'Incompatible script identifier found in the hash');
});

test("should throw an error if the 'ln' parameter is missing", async t => {
  const wrong =
    '$scrypt$r=8,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';

  const err = await t.throws(m.verify(wrong, 'password'));
  t.is(err.message, "The 'ln' param must be an integer");
});

test("should throw an error if the 'ln' parameter is out of range", async t => {
  let wrong =
    '$scrypt$ln=0,r=8,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';

  let err = await t.throws(m.verify(wrong, 'password'));
  t.regex(err.message, /The 'ln' param must be in the range/);

  wrong =
    '$scrypt$ln=256,r=8,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';
...
test("should throw an error if the 'r' parameter is missing", async t => {
  const wrong =
    '$scrypt$ln=16,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';
...
test("should throw an error if the 'r' parameter is out of range", async t => {
  let wrong =
    '$scrypt$ln=16,r=-1,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';

  let err = await t.throws(m.verify(wrong, 'password'));
  t.regex(err.message, /The 'r' param must be in the range/);

  wrong =
    '$scrypt$ln=16,r=4294967296,p=1$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';
...
test("should throw an error if the 'p' parameter is missing", async t => {
  const wrong =
    '$scrypt$ln=16,r=8$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';
...
test("should throw an error if the 'p' parameter is out of range", async t => {
  let wrong =
    '$scrypt$ln=16,r=8,p=0$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';

  let err = await t.throws(m.verify(wrong, 'password'));
  t.regex(err.message, /The 'p' param must be in the range/);

  wrong =
    '$scrypt$ln=16,r=8,p=4294967296$aM15713r3Xsvxbi31lqr1Q$nFNh2CVHVjNldFVKDHDlm4CbdRSCdEBsjjJxD+iCs5E';
...
test('should throw an error if salt is not given', async t => {
  const wrong = '$scrypt$ln=16,r=8,p=1';
...
test('should throw an error if hash is not given', async t => {
  const wrong = '$scrypt$ln=16,r=8,p=1$aM15713r3Xsvxbi31lqr1Q';
